package com.oerineor.gjroijhort.app.event
...
//import com.oerineor.gjroijhort.app.utils.jsonToMap
...
//
//        val config = AdjustConfig(App.getInstance(), ajToken, AdjustConfig.ENVIRONMENT_PRODUCTION)
...
//        App.getInstance().registerActivityLifecycleCallbacks(AdjustLifecycleCallbacks())
